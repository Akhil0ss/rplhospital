 ...
 * FIX: optional parsedBody to avoid reading stream after response
 */
export async function handleWebhook(request, env, parsedBody = null) {
    try {
        const body = parsedBody || await request.json();  // 🔧 only fix
